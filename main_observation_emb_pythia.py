...
from utils import convert_pythia_emb_orth_output, GPTNeoXLayer_Outemb
...
def main():
    ...
    model = convert_pythia_emb_orth_output(model, config)
    ...
    for iterations, batch in enumerate(eval_dataloader):
        ...
        for name, m in model.named_modules():
            if isinstance(m, GPTNeoXLayer_Outemb):
