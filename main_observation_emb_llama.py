...
from utils import LlamaDecoderLayer_Outemb, convert_llama_emb_orth_output
...
def main():
    ...
    model = convert_llama_emb_orth_output(model, config)
    ...
    for iterations, batch in enumerate(eval_dataloader):
        ...
        for name, m in model.named_modules():
            if isinstance(m, LlamaDecoderLayer_Outemb):
