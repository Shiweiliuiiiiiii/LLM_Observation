...
from utils import convert_llama_emb_orth_output_Modify_position, LlamaDecoderLayer_Outemb_Modify_position
from modify_llama import MultiCompressLlamaAttention, MultiCompressLlamaForCausalLM
...
def main():
    ...
    if args.random_init:
        ...
        model = MultiCompressLlamaForCausalLM.from_pretrained(args.model_name_or_path, config=config,
            revision=args.revision, cache_dir=args.cache_dir)

    # pretrained_weight = copy.deepcopy(model.state_dict())
    # model = convert_llama_emb_orth_output_Modify_position(model, config)
    ...
    for iterations, batch in enumerate(eval_dataloader):
        ...
        for name, m in model.named_modules():
            if isinstance(m, LlamaDecoderLayer_Outemb_Modify_position):
